            ...
            <section class="sec-filmes pb-5" id="lista-filmes">
                <div class="container px-lg-5 pt-3">
                    ...
                    <div class="row">
                        ...
                        $query = "SELECT id_filmes, capa, titulo, tipo FROM filmes_favoritos INNER JOIN filmes ON ref_filmes = id_filmes INNER JOIN generos ON ref_generos = id_generos WHERE filmes_favoritos.ref_utilizadores = ?";
